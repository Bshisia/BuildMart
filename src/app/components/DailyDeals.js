    ...
    <section className="mb-10">
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold text-secondary dark:text-white">Today&apos;s Deals</h2>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Mins</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-red-600 dark:text-red-400">22</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Secs</div>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {deals.map((deal) => (
            <div key={deal.id} className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-2">{deal.name}</h3>
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <span className="text-xl font-bold text-red-600 dark:text-red-400">KES {deal.price.toLocaleString()}</span>
